		...
		<div class="container-login100"
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				...
				<form class="login100-form validate-form "
					id="customerForm" action="../ExecutiveController" method="post">
					<div class="wrap-input100 validate-input m-b-23"
						...
						<span class="label-input100">Name</span> <input
							...
							placeholder="Enter the name..." /> <span class="focus-input100"
							></span>
					</div>
					
					<div class="wrap-input100 validate-input m-b-23"
						data-validate="Enter a valid SSN">
						<span class="label-input100" id="ssn">Social Security Number</span> <input
							class="input100 form-inline form-control" type="text" id="ssno" name="ssn" maxLength="9"
							placeholder="Enter the ssn..." /> <span class="focus-input100"
							></span>
					</div>
					<div class="wrap-input100 validate-input m-b-23"
					...
					<div class="wrap-input100 validate-input m-b-23"
						...
						<span class="label-input100">Address</span> <input
							class="input100 form-control" type="text" placeholder="Enter the address..." id="address" name="address" 
							 /> <span class="focus-input100"
							></span>
					</div>
					...
					<div class="btn-group">
					<center>
 					 <button type="reset" class="btn btn-primary active" id="reset">Reset</button>&ensp;
  					<input type="submit" class="btn btn-primary active" id="submitForm" value="Create"/>
  					</center>
  				</div>
